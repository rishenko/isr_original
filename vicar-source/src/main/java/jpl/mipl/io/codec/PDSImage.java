...
/**
 * PDSImage holds the PDS image headers and data. If this image is a "Dualie"
 * which means it also contains an embedded Vicar image label then this embedded
 * Vicar label will be read and a VicarLabel Object will be created.<br>
 * The VicarLabel Object will be placed into a property "vicar_label".
 * 
 * @see VicarImage
...
public class PDSImage extends VicarImage {
	...
	/**
	 * @param input
	 *            the SeekableStream conatining the image data.
	 */
	...
	/**
	 * @param input
	 *            the SeekableStream containing the image data.
	 */
	 ...
	 *            the SeekableStream containing the image data.
	 * @param tileSize
	 *            sets the tileHeight and tileWidth to this value
	 */
