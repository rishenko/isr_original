 ...
 * 
 * <p>
 * The Vicar file format includes BSQ for grey scale images, and BIP for color
 * images. When writing the source data out, the encoder chooses the appropriate
 * file variant based on the actual SampleModel of the source image. In case the
 * source image data is unsuitable for the Vicar file format, for example when
 * source has other than 1 or 3 bands, the encoder throws an Error. <BR>
...
public class VicarImageEncoder extends ImageEncoderImpl {
	...
	private static final String COMMENT = "# written by VicarImageEncoder";

	public VicarImageEncoder(OutputStream output, ImageEncodeParam param) {
		super(output, param);
	...
	public void encode(RenderedImage im) throws IOException {
		 ...
		 * DataBuffer.TYPE_DOUBLE)) { System.out.println(
		 ...
		 * System
		 * .out.println("sampleSize[0]="+sampleSize[0]+"  numBands="+numBands
		 * +"  dataType="+dataType );
