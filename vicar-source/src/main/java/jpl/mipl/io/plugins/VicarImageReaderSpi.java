...
public class VicarImageReaderSpi extends ImageReaderSpi {
	...
	private static final String[] MIMEtypes = { "image/x-vic", "image/x-vicar", "image/x-img", "image/img",
			"image/vic", "image/vicar" };

	private static final String readerClassName = VicarImageReader.class.getCanonicalName();

	// Class names are given as strings to avoid loading classes
	// until they are needed.
	private static final String[] writerSpiNames = { VicarImageWriterSpi.class.getCanonicalName() };
	...
	public VicarImageReaderSpi() {
		...
		super(vendorName, version, names, suffixes, MIMEtypes, readerClassName, STANDARD_INPUT_TYPE, writerSpiNames,
				...
				VicarMetadata.nativeStreamMetadataFormatName, VicarMetadata.nativeStreamMetadataFormatClassName,
				...
				VicarMetadata.nativeImageMetadataFormatName, VicarMetadata.nativeImageMetadataFormatClassName,
	...
	public boolean canDecodeInput(Object input) throws IOException {
		...
		return ((header[0] == 'L') && (header[1] == 'B') && (header[2] == 'L') && (header[3] == 'S')
				&& (header[4] == 'I') && (header[5] == 'Z') && (header[6] == 'E') && (header[7] == '='));
	...
	public ImageReader createReaderInstance(Object extension) {
		...
		if (debug)
			System.out.println(" createReaderInstance VicarImageReader extension=" + extension);
